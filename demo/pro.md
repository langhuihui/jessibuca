...
| 浏览器    | wasm | wasm simd | mse 解码H264| mse 解码H265 | webcodecs 解码H264 | webcodecs 解码H265|
|:-------| :--- | :--- |:-----------| :--- |:-----------------| :--- |
| Safari | 支持 | 不支持 | 不支持        | 不支持 | 支持               | 不支持 |
| Chrome | 支持 | 不支持 | 不支持         | 不支持 | 支持  | 不支持 |
| 微信内置   | 支持 | 不支持 | 不支持         | 不支持 | 支持  | 不支持 |
...
目前播放器对接了`M7S的私有格式加密流`,`国标SM4加密流`播放
