...
| WASM(SIMD)支持webgpu canvas渲染                                                                                                                                                                                                                                                      | 不支持 | 支持  |
| WASM(SIMD)支持canvas渲染                                                                                                                                                                                                                                                             | 不支持 | 支持  |
...
| WebRTC协议流(H265)(datachannel传递数据) m7s 服务器                                                                                                                                                                                                                                         | 不支持 | 支持  |
| WebRTC协议流(H264/H265) zlmediakit 服务器                                                                                                                                                                                                                                              | 不支持 | 支持  |
| WebRTC协议流(H264/H265) SRS 服务器                                                                                                                                                                                                                                                     | 不支持 | 支持  |
| WebRTC协议流(H264/H265) 其他服务器                                                                                                                                                                                                                                                       | 不支持 | 支持  |
| 支持WebRTC协议流弱网络模式，提升弱网环境下的播放体验，优化播放卡顿，支持检测低fps情况触发重播逻辑，保证业务播放体验                                                                                                                                                                                                                   | 不支持 | 支持  |
| 阿里云Web Rtc                                                                                                                                                                                                                                                                       | 不支持 | 支持  |
| WebRTC协议流(H264/H265) 七牛云服务器                                                                                                                                                                                                                                                      |不支持|支持|
| WebRTC协议流(H264/H265) 大疆服务器                                                                                                                                                                                                                                                       |不支持|支持|
...
| VR 全景播放（点播文件,直播流） [扩展模块](https://jessibuca.com/pro-module.html)                                                                                                                                                                                                                  | 不支持  | 支持  |
...
| GB28181 TF卡（录像流）流播放 [介绍](https://jessibuca.com/pro-playback-gb28181.html)                                                                                                                                                                                                        | 不支持 | 支持  |
...
| GA/T 1078 TF卡（录像流）流播放 [介绍](https://jessibuca.com/pro-playback-gat1078.html)                                                                                                                                                                                                      | 不支持 | 支持  |
| GA/T 1078 TF卡（录像流）流播放，（2/4/8/16/32/64）倍率播放                                                                                                                                                                                                                                       | 不支持 | 支持  |
| GA/T 1078 TF卡（录像流）流播放，关键帧解码播放                                                                                                                                                                                                                                                    | 不支持 | 支持  |
| GA/T 1078 TF卡（录像流）流播放，配套UI 24小时进度条                                                                                                                                                                                                                                               | 不支持 | 支持  |
| GA/T 1078 TF卡（录像流）流播放，配套UI 固定时长进度条                                                                                                                                                                                                                                               | 不支持 | 支持  |
| GA/T 1078 TF卡（录像流）流播放，配套UI 倍率（1/2/4/8/16/32/64）选择                                                                                                                                                                                                                                | 不支持 | 支持  |
| GA/T 1078 TF卡（录像流）流播放，暂停播放但不断开连接                                                                                                                                                                                                                                                 | 不支持 | 支持  |
| GA/T 1078 TF卡（录像流）流播放，直接解码前缓存数据                                                                                                                                                                                                                                                  | 不支持 | 支持  |
| 支持特殊回放流播放[介绍](https://jessibuca.com/pro-playback-special.html)                                                                                                                                                                                                                   |不支持|支持|
| 支持特殊回放流播放，（0.1/0.5/1/2/4/8/16）倍率播放                                                                                                                                                                                                                                               | 不支持 | 支持  |
| 支持特殊回放流播放，暂停播放但不断开连接                                                                                                                                                                                                                                                             | 不支持 | 支持  |
| 支持特殊回放流播放，支持逐帧播放                                                                                                                                                                                                                                                                 |  不支持|支持   |
| 支持特殊回放流播放，支持逐关键帧播放                                                                                                                                                                                                                                                               |   不支持| 支持|
| 支持点播文件(Mp4)播放，支持H264/H265编码格式 + aac/g711a/g711u,支持硬解码、软解码播放。                                                                                                                                                                                                                     | 不支持 | 支持  |
| 支持点播文件(HLS)播放，支持H264/H265编码格式 + aac/mp3,支持硬解码、软解码播放。                                                                                                                                                                                                                             | 不支持 | 支持  |
| 支持点播文件(MP4/HLS)播放,支持选择倍率（0.1/0.5/1/2/4/8/16）                                                                                                                                                                                                                                     | 不支持 | 支持  |
| 支持点播文件(MP4/HLS)播放，支持逐帧播放                                                                                                                                                                                                                                                         | 不支持 | 支持  |
| 支持点播文件(MP4/HLS)播放，支持逐关键帧播放                                                                                                                                                                                                                                                       | 不支持 | 支持  |
| UI控件[PTZ](https://jessibuca.com/pro-ptz.html)（云台）操作盘<br/>(支持配置点击事件和鼠标按下和松开事件两种交互)                                                                                                                                                                                                | 不支持 | 支持  |
| UI控件PTZ（云台）操作盘支持两种布局（横向，纵向）                                                                                                                                                                                                                                                      | 不支持 | 支持  |
| UI控件PTZ（云台）操作盘支持拖拽                                                                                                                                                                                                                                                               | 不支持 | 支持  |
| UI控件PTZ（云台 镜头(+/-)，聚焦(+/-)，光圈(+/-) ，巡航(开/关)，透雾(开/关)，雨刷(开/关)按钮                                                                                                                                                                                                                    | 不支持 | 支持  |
| UI控件PTZ（云台）支持生成国标编码                                                                                                                                                                                                                                                              | 不支持 | 支持  |
...
| 支持通过ws接口获取服务器端画面坐标系（文字、线条、矩形框子、文字+矩形框子、不规则多边形）<br/>实时渲染在播放器上，                                                                                                                                                                                                                    | 不支持 | 支持  |
...
| 支持异常断开重连,自动续连(超时、断网重连、异常暂停播放等,支持配置不黑屏）                                                                                                                                                                                                                                           | 不支持 | 支持  |
| 支持国际化配置                                                                                                                                                                                                                                                                          | 不支持 | 支持  |
| 提供业务解决方案文档                                                                                                                                                                                                                                                                       | 不支持 | 支持  |
| 支持定制化服务开发                                                                                                                                                                                                                                                                        | 不支持 | 支持  |
