...
期中http(s)-mp4支持H264、H265视频编码格式，AAC、G711A、G711U音频编码格式。

> G711A、G711U音频编码格式 不支持MSE解码。支持WCS/WASM/WASM(SIMD)解码。

http(s)-hls(mp4)支持H264、H265视频编码格式，AAC、G711A、G711U音频编码格式。

> G711A、G711U音频编码格式 不支持MSE解码。支持WCS/WASM/WASM(SIMD)解码。

http(s)-hls(ts)支持H264、H265视频编码格式，AAC、MP3音频编码格式。
...
> G711A、G711U编码格式只支持Flv/Hls-Mp4封装格式的流。

> AAC 编码格式支持所有封装格式的流。

> MP3 编码格式只支持Flv/TS/Hls-Ts封装格式的流。
