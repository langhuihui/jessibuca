    ...
    class Player extends Emitter {
      ...
      play(url) {
        return new Promise((resolve, reject) => {
          ...
          this._opt.url = url;
          this.init().then(() => {
            this.stream.fetchStream(url); // fetch error
      ...
      destroy() {
        ...
        this._loading = false;
        this._playing = false;
        this._hasLoaded = false; // 其他没法解耦的，通过 destroy 方式
