...
`;
    ...
    var observer = ((player, control) => {
      ...
      player.on(EVENTS.loading, () => {
        setStyle$1(control.$loading, 'display', player.loading ? 'flex' : 'none');
      });

      try {
        const screenfullChange = () => {
          setStyle$1(control.$fullscreenExit, 'display', player.fullscreen ? 'flex' : 'none');
          setStyle$1(control.$fullscreen, 'display', player.fullscreen ? 'none' : 'flex'); // control.autoSize();
        };
