    ...
    return (
        function (Module) {
            ...
            Module["locateFile"] = function (url) {
                ...
                if (url == "decoder-pro-simd-mt-worker.worker.js" && typeof JESSIBUCA_PRO_SIMD_MT_WORKER_JS_URL != "undefined" && JESSIBUCA_PRO_SIMD_MT_WORKER_JS_URL != "") {
            ...
            if (Module["locateFile"]) {
                ...
                wasmBinaryFile = new URL("decoder-pro-simd-mt-worker.wasm", import.meta.url).toString()
            }
            ...
            var PThread = {
                unusedWorkers: [], runningWorkers: [], tlsInitFunctions: [], pthreads: {}, init: function () {
                    ...
                    if (!Module["locateFile"]) {
                        PThread.unusedWorkers.push(new Worker(new URL("decoder-pro-simd-mt-worker.worker.js", import.meta.url)));
                        return
                    }
            ...
            var asmLibraryArg = {
                ...
                "K": ___cxa_throw,
                "C": ___emscripten_init_main_thread_js,
                ...
                "z": __emscripten_default_pthread_stack_size,
                "E": __emscripten_notify_task_queue,
                "B": __emscripten_set_offscreencanvas_size,
            ...
            var __emscripten_tls_init = Module["__emscripten_tls_init"] = function () {
                return (__emscripten_tls_init = Module["__emscripten_tls_init"] = Module["asm"]["R"]).apply(null, arguments)
            };
            ...
            var __emscripten_thread_free_data = Module["__emscripten_thread_free_data"] = function () {
                return (__emscripten_thread_free_data = Module["__emscripten_thread_free_data"] = Module["asm"]["_"]).apply(null, arguments)
            };
            var __emscripten_thread_exit = Module["__emscripten_thread_exit"] = function () {
                return (__emscripten_thread_exit = Module["__emscripten_thread_exit"] = Module["asm"]["$"]).apply(null, arguments)
            };
            ...
            var stackRestore = Module["stackRestore"] = function () {
                return (stackRestore = Module["stackRestore"] = Module["asm"]["ca"]).apply(null, arguments)
            };
            var stackAlloc = Module["stackAlloc"] = function () {
                return (stackAlloc = Module["stackAlloc"] = Module["asm"]["da"]).apply(null, arguments)
            };
